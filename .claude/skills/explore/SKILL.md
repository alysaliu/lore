---
name: explore
description: Explore the codebase and clarify with me to understand how a feature should be implemented
---
...
- Clearly identify anything unclear or ambiguous in my description or the current implementation for the UX.
